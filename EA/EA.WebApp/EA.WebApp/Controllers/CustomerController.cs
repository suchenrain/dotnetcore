...
using DAL;
using EA.WebApp.ViewModels;
using AutoMapper;
using DAL.Models;
using Microsoft.Extensions.Logging;
using EA.WebApp.Helpers;

namespace EA.WebApp.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) response = await EmailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from EA.WebApp", message);
